...
export async function getTokenScopeL2Summary(
  ...
  }>('/api/tokenscope/l2/summary', { params, skipErrorHandler: true, skipAuthReset: true })
  return res.data.data || []
}
...
export async function getTokenScopeL2ByDimension(
  ...
  const res = await api.get<{
    success: boolean
    data: TokenScopeL2Summary[]
  }>('/api/tokenscope/l2/by-dimension', { params, skipErrorHandler: true, skipAuthReset: true })
  return res.data.data || []
}
...
export async function getTokenScopeSelfL2ByDimension(
  ...
  const res = await api.get<{
    success: boolean
    data: TokenScopeL2Summary[]
  }>('/api/tokenscope/self/l2/by-dimension', { params, skipErrorHandler: true, skipAuthReset: true })
  return res.data.data || []
}
...
export async function getTokenScopeL2Recent(
  ...
  }>('/api/tokenscope/l2/recent', { params, skipErrorHandler: true, skipAuthReset: true })
  return res.data.data || []
}
...
export async function getTokenScopeL2RequestDetail(
  ...
  }>(`/api/tokenscope/l2/request/${requestId}`, { skipErrorHandler: true, skipAuthReset: true })
  return res.data.data
}
...
export async function getTokenScopeSelfL2Recent(
  ...
  const res = await api.get<{
    success: boolean
    data: RequestDebugPayload[]
  }>('/api/tokenscope/self/l2/recent', { params, skipErrorHandler: true, skipAuthReset: true })
  return res.data.data || []
}
